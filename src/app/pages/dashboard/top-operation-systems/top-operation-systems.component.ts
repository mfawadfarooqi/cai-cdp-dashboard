...
@Component({
  selector: 'app-top-operation-systems',
  standalone: true,
  imports: [
    NgxEchartsDirective,
    NgIf
  ],
  templateUrl: './top-operation-systems.component.html',
  styleUrl: './top-operation-systems.component.css'
})
export class TopOperationSystemsComponent implements OnInit, OnDestroy {
  ...
  getCounts(endDate, startDate) {
    this.dashboardService.getLookupServices(null, 'OS', endDate, startDate).subscribe(res => {
